...
const Product = () => {
  // Category data
  const categoryItems = [
    { name: "Chair", selected: true },
    { name: "Sofa", selected: false },
    { name: "Couch", selected: false },
    { name: "Desk", selected: false },
    { name: "Lamp", selected: false },
  ];

  // Materials data
  const materialsItems = [
    { name: "Bronze", count: 8, selected: true },
    { name: "Oak wood", count: 12, selected: false },
    { name: "Stainless metal", count: 36, selected: false },
    { name: "Titanium", count: 4, selected: false },
    { name: "Alloy", count: 8, selected: false },
    { name: "Ceramic", count: 17, selected: false },
  ];

  // Size data
  const sizeItems = [
    { name: "S", count: 8, selected: true },
    { name: "M", count: 12, selected: false },
    { name: "L", count: 36, selected: false },
  ];

  // Pagination data
  const paginationItems = [
    { page: "01", active: true },
    { page: "02", active: false },
    { page: "03", active: false },
  ];
            ...
            <div className="w-[254px] flex-shrink-0">
              ...
              <div className="flex flex-col items-start gap-10">
                <div className="flex flex-col items-start gap-3 w-full">
                  <h2 className="font-h2-24-extra-bold text-black-1 tracking-[var(--h2-24-extra-bold-letter-spacing)] leading-[var(--h2-24-extra-bold-line-height)]">
                    CATEGORY
                  </h2>
                ...
                <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionContent>
                      <div className="flex flex-col gap-4">
                        {categoryItems.map((item, index) => (
                          <div
                            key={index}
                            className={`${item.selected ? "font-h3-16-bold text-black-1" : "font-h3-16-medium text-black-3"}`}
                          >
                            {item.name}
                          </div>
                        ))}
                  ...
                  >
                    ...
                    <AccordionContent>
                      {/* All product content would go here */}
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-4">
                  <Badge className="bg-[#ce0000] text-bg-1 font-h3-16-bold h-10 px-5 rounded-none">
                    ON SALE
                  </Badge>
                ...
                <div className="flex items-center">
                  <div className="flex items-center">
                    <Button
                      variant="outline"
                      className="bg-black-7 h-10 w-10 p-2.5 rounded-none"
                    >
                  ...
                  <span className="ml-8 font-h3-16-medium text-black-1 text-center whitespace-nowrap">
              ...
              <div className="flex justify-between items-center mt-16 pt-8">
                <Pagination>
                  <PaginationContent className="flex items-center gap-2">
                    <PaginationItem>
                      <PaginationLink className="w-10 h-10 flex items-center justify-center bg-black-7 text-black-1 rounded-none border-0">
                    ...
                    <PaginationItem>
                      <PaginationLink className="w-10 h-10 flex items-center justify-center bg-black-1 text-black-8 rounded-none border-0">
