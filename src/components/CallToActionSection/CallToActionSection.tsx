    ...
    <section className="w-full py-10 overflow-hidden">
      <Card className="max-w-[1392px] mx-auto relative">
        <CardContent className="p-0">
          <div className="bg-black-7 relative flex flex-wrap lg:flex-nowrap items-center p-16">
            {/* Left side - Product info */}
            <div className="flex flex-col space-y-4 z-10 lg:w-1/3">
              ...
              <div className="flex items-center gap-4 mt-4">
                <div className="font-h1-32-extra-bold font-[number:var(--h1-32-extra-bold-font-weight)] text-black-1 text-[length:var(--h1-32-extra-bold-font-size)] tracking-[var(--h1-32-extra-bold-letter-spacing)] leading-[var(--h1-32-extra-bold-line-height)] [font-style:var(--h1-32-extra-bold-font-style)]">
                  $2352.41
                </div>
            ...
            <div className="relative flex justify-center lg:w-1/3">
              <div className="w-[221px] h-[299px] absolute bottom-0 bg-[#ffd68a4c] rounded-[110.5px/149.5px] blur-[50px]" />
              <img
                className="relative w-auto h-[474px] z-10"
            ...
            <div className="flex flex-col items-end space-y-8 lg:w-1/3 z-10">
              ...
              <Button className="w-56 h-auto p-3 bg-black-1 rounded-none hover:bg-black-1/90">
