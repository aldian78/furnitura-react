...
export const ProductDetailsSection = () : JSX.Element => {
    ...
    return (
        <section className="w-full bg-black-7 mb-20">
            <div className="flex flex-wrap text-left gap-8 px-4 lg:px-24">
            ...
            <div className="w-full pb-16 bg-white">
                <div className="flex items-center grid grid-cols-1 justify-between">
                    ...
                    <div className="relative w-full mt-12 flex items-center justify-center">
                        ...
                        <img
                            src={activeImage}
                            alt="Product"
                            className="w-[300px] h-[350px] absolute top-1/2 mt-10 -translate-y-[60%] left-1/2 -translate-x-1/2 object-contain z-10"/>
                    </div>

                    {/* Thumbnail Gallery */}
                    <div className="mt-16 overflow-x-auto scrollbar-hide">
                        <div className="flex flex-nowrap gap-4 justify-start w-max px-2 my-2">
                    ...
                    <Card
                        className="flex-1 mt-16 max-w-[520px] shadow-[0px_0px_0px_#0000000d,0px_20px_45px_#0000000a,0px_81px_81px_#0000000a,0px_183px_110px_#00000005,0px_326px_130px_#00000003,0px_509px_142px_transparent] bg-black-8">
                            ...
                            <div className="flex items-center justify-between w-full">
                                <div className="flex h-12 items-center gap-3 px-6 py-3 bg-black-7 rounded-sm">
                                    ...
                                    <div
                                        ...
                                        <span className="select-none font-medium text-black-3">Quantity:</span>
                                ...
                                <div
                                    className="select-none text-xl font-extrabold font-[number:var(--text-xl font-extrabold-font-weight)] text-[#ce0000] text-[length:var(--text-xl -extra-bold-font-size)] tracking-[var(--h1-32-extra-bold-letter-spacing)] leading-[var(--h1-32-extra-bold-line-height)] [font-style:var(--h1-32-extra-bold-font-style)]">
                                    Rp. 10.000.000
                                </div>
                            </div>
